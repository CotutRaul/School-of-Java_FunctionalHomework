...
public class CrazyLambdas {
    ...
    public static Predicate<String> lengthInRangePredicate(int min, int max) {
        return s -> s.length()<max && min <= s.length();
    }
...
//        System.out.println(nMultiplyFunctionSupplier(10).get().applyAsInt(5));
//    }
    ...
    public static UnaryOperator<Function<String, String>> composeWithTrimFunction() {
        return s -> s.compose(String::trim);
    }

//    public static void main(String[] args) {
//        String s = "            Cotut   ";
//        System.out.println(composeWithTrimFunction().apply(a -> "?" + a).apply(s));
//    }
...
//        runningThreadSupplier(runnable).get().start();
//    }
...
//        Runnable runnable =
//                () -> { System.out.println("Lambda Runnable running"); };
//        newThreadRunnableConsumer().accept(runnable);
//    }
...
//        Runnable runnable =
//            () -> { System.out.println("Lambda Runnable running"); };
//        runnableToThreadSupplierFunction().apply(runnable).get().start();
//    }
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        return (u,p) -> i -> p.test(i) ? u.applyAsInt(i) : i;
    }
